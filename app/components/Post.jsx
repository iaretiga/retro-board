...
class Post extends Component {
    ...
    renderButtons(){
        ...
        if (this.props.currentUser === post.user) {
            return <Button icon="&#xE56A;" label="Delete" flat primary style={{ backgroundColor: '#FF9494', color: 'white', tabIndex: -1 }} onClick={() => this.props.onDelete(post)} />;
        } else {
            return (
                <span>
                    <IconButton icon="&#xE56A;" floating mini style={{ backgroundColor: '#6BD173', color: 'white' }}
